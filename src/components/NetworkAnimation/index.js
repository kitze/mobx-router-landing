...
//styled-components
import {NetworkAnimation} from './styles';

class NetworkAnimationComponent extends Component {
  ...
  render() {
    return (
      <NetworkAnimation className="svg-container">
...
export default NetworkAnimationComponent;
